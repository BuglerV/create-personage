<x-app-layout>
    ...
    <x-window>
	    <x-slot name="header">
		    <x-back-link href="{{ route('ability.index',$group) }}"/>
		...
		<form method="POST" action="{{ route('ability.store',$group) }}">
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="col-md-6">
					<input id="color" type="color" class="form-control !py-0 !px-1 @error('color') is-invalid @enderror" name="color" value="{{ old('color') }}" required autocomplete="color" autofocus>
